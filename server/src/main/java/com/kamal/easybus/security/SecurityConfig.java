...
import com.kamal.easybus.security.jwt.JwtAuthenticationEntryPoint;
import com.kamal.easybus.security.jwt.JwtAuthenticationFilter;
        ...
        http
                ...
                .authorizeRequests()
                    .antMatchers("/",
                        ...
                        "/**/*.js")
                        .permitAll()
                .antMatchers("/api/v2/api-docs/**", "/swagger-ui/**")
                        .permitAll()
                .antMatchers("/api/v1/auth/**", "/api/v1/paypal/**", "/actuator/**")
                        .permitAll()
